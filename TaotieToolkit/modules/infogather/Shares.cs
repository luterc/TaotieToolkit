...
{
    internal class Shares : ICommand, ICommandMarker
    {
        public string Name => "Shares";
        public string Description => "List network share information from all machines in the current domain";
        ...
        private void DefineParams()
        {
            argParse = new ArgParse {
                new OptionSet("ips") {
                    new Option("-i", "--ips", "Output computer information in the format of $HOSTNAME: $IP", true, false),
                },
                new OptionSet("shares") {
                    new Option("-s", "--shares", "Query each computer in the domain for network shares and if they're readable by the current user.", true, false),
                },
                new OptionSet("versions") {
                    new Option("-v", "--versions", "GetComputer Versions", true, false),
                },
            };
        }
